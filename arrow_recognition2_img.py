...
def rescaleFrame(frame, scale = 1.5):  # work for images, video and live vids
...
#allImages = python_utils.stackImages(0.5,([img, imgGray, imgOut],
                           #    [imgCanny, imgDilated, imgEroded]))

#cv2.imwrite("img21.jpg", cap)
#cv2.imwrite("img1.jpg",imgOut)
cv2.imshow("Image processing", imgOut)
cv2.waitKey(0)
